...
export async function FuelFilterLoader(fuelFilter, fuelFilterValue) {
  const BASE_URL = "https://uk-daily-fuel-prices.p.rapidapi.com";
  ...
  try {
    switch (fuelFilter) {
      ...
      case "specific":
        endpoint = `/api/petrol-prices/brand/${fuelFilterValue}?page=5&limit=20`;
        break;

      case "fuel-type":
        endpoint = `/api/petrol-prices/fuel-type/${fuelFilterValue}`;
        break;
